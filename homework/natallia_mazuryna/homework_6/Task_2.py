...
first_result_number_index = first_result_line.index('42')
final_1st_number = first_result_line[first_result_number_index:]
...
second_result_number_index = second_result_line.index('547')
final_2nd_number = second_result_line[second_result_number_index:]
final_2nd_number_int = int(final_2nd_number)
second_final_result = final_2nd_number_int + 10
print(second_final_result)

third_result_line = 'результат: 5'
third_result_number_index = third_result_line.index('5')
final_3rd_number = third_result_line[third_result_number_index:]
